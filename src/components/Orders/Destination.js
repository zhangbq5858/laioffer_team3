      ...
      <Fragment>
        <Form onSubmit={this.handleSubmit} className="form-wrapper">
          ...
          >
            ...
            >
              {getFieldDecorator('fName-to', {
                rules: [{ required: true, message: 'Please input your first name!' }],
              })(
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.fName")}
                />
              )}
            ...
            <Form.Item
              ...
              style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}
            >
              {getFieldDecorator('lName-to', {
                rules: [{ required: true, message: 'Please input your last name!' }],
              })(
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.lName")}
                />
              )}
            </Form.Item>
          </Form.Item>
          ...
          >
            {getFieldDecorator('add-to', {
              rules: [{ required: true, message: 'Please input your address!' }],
            })(
              <Input onChange={this.props.handleChange("to_address.street")}/>
            )}
          </Form.Item>
          ...
          >
            ...
            >
              {getFieldDecorator('city-to', {
                rules: [{ required: true, message: 'Please input your city!' }],
              })(
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.city")}
                />
              )}
            ...
            >
              {getFieldDecorator('state-to', {
                rules: [{ required: true, message: 'Please input your state!' }],
              })(
                <Select placeholder="Select one State" style={{ display: 'inline-block', width: '100%' }} onChange={this.props.handleChange("to_address.state")}>
                  {
            ...
            >
              {getFieldDecorator('zip-to', {
                ...
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.zipcode")}
                />
              )}
            </Form.Item>
          </Form.Item>
          ...
          >
            ...
            >
              {getFieldDecorator('email-to', {
                ...
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.email")}
                />
              )}
            ...
            <Form.Item
              ...
              style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}
            >
              {getFieldDecorator('phone-to', {
                rules: [{ required: true, message: 'Please input your phone number!' }],
              })(
                <Input
                  style={{ display: 'inline-block', width: '100%' }}
                  onChange={this.props.handleChange("to_address.phone")}
                />
              )}
            </Form.Item>
          </Form.Item>
